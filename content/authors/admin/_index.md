...
social:
  ...
  - icon: google-scholar # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: ai
    link: https://scholar.google.com/citations?user=4PKMMLwAAAAJ&hl=pt-PT
  - icon: researchgate
    icon_pack: ai
    link: https://www.researchgate.net/profile/Francisco-Cruz-16
  - icon: orcid
    icon_pack: ai
    link: https://orcid.org/0000-0002-3160-7054
  - icon: ciencia-vitae
    icon_pack: ai
    link: https://www.cienciavitae.pt/portal/CA16-43ED-7124
  - icon: linkedin
    icon_pack: fab
